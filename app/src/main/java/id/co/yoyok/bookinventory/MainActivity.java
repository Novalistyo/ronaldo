package id.co.yoyok.bookinventory;
...
import id.co.yoyok.bookinventory.core.CoreApplication;
import id.co.yoyok.bookinventory.fragment.AboutFragment;
import id.co.yoyok.bookinventory.fragment.HomeFragment;
import id.co.yoyok.bookinventory.helper.SessionManagement;
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case R.id.homeCatalog:
                ...
                title = "Novalistyo Books Catalog";
                break;
            case R.id.about:
